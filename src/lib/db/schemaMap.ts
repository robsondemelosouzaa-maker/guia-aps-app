...
export const MODULES: Record<ModuleSlug, ModuleConfig> = {
    ...
    gestante: {
        ...
        hiddenFields: ['id', 'user_id', 'created_at', 'clinical_data', 'is_pregnant', 'alert', 'status_original', 'age'],
        readonlyFields: ['id', 'user_id', 'created_at'],
        defaultOrder: { column: 'name', ascending: true },
        hasBabyBorn: true,
        hasChecklist: true,
        createDefaults: { is_pregnant: true, status: 'gestante' },
    },
    ...
    crianca: {
        ...
        nameField: 'name',
        riskField: 'risk_level',
        hiddenFields: ['id', 'user_id', 'created_at', 'alert'],
        readonlyFields: ['id', 'user_id', 'created_at'],
    ...
    cronicos: {
        ...
        nameField: 'name',
        riskField: 'risk_level',
        hiddenFields: ['id', 'user_id', 'created_at', 'clinical_data', 'insulin_expiry_date', 'alert', 'consulta_1', 'consulta_2', 'consulta_3', 'consulta_4'],
        readonlyFields: ['id', 'user_id', 'created_at'],
        defaultOrder: { column: 'name', ascending: true },
    },
...
export const FIELD_LABELS: Record<string, string> = {
    ...
    alert: '⚠️ Alerta do Paciente',
    consulta_1: '1ª Consulta Anual',
    consulta_2: '2ª Consulta Anual',
    consulta_3: '3ª Consulta Anual',
    consulta_4: '4ª Consulta Anual',
};
